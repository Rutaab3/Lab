...
$dashboard_map = [
    ...
    'analyst'  => './dashboard/analyst.php',
    'tester'   => './dashboard/tester.php',
    'supplier' => './dashboard/supplier.php',
    'user'     => 'index.php'
];
$back_url = $dashboard_map[$role] ?? 'users.php';
      ?>
      <button onclick="window.location.href = '<?php echo $back_url ?>'">Go Back</button>
      <!-- <button onclick="window.location.href = '<?php echo $back_url ?>'">Login</button> -->
    </div>
  </div>
</body>
</html>
